            ...
            <div className="flex justify-center items-center md:items-start flex-col w-full md:w-[274px] h-full">
              ...
              <div className="flex md:order-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center justify-center gap-2 border bg-green-450 hover:bg-green-500 text-white focus:ring-4 focus:outline-none font-medium font-inter rounded-xl  
